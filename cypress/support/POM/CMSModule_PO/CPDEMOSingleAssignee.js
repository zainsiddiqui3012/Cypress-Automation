...
const filename = 'cypress/fixtures/CMSIssueExternalWebforms/TicketIDSingleCPDEMO.txt'

class CPDEMOSingleAssignee {
    setCustomerProfile(issueOwnerType, issueOwnerTypeName, customerProfileUpdatemsg) {
        cy.wait(10000);
        cy.get('.form-group.m-form__group.row.pb-3:nth-child(24) > .col-md-6 > .m-radio-inline').contains(issueOwnerType).click();
        cy.wait(3000);
...
export default CPDEMOSingleAssignee