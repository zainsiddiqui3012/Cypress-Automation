...
import KXI_POM from "../../../support/POM/KXIModule/KxI_POM.js"; //importing KXI_POM class
...
describe(
  ...
  () => {
    ...
    let Key = Cypress.env("kxi").customer.withoutRM.key;
    const kxiDef = new KXI_POM();
    context(
      "Role Permission for Lumify Customer",
      { tags: ["@withoutRM"] },
      () => {
    ...
    context(
      "KXI Role Permission without Session for Lumify Customer",
      { tags: ["@withoutRM"] },
      () => {
        const kxi = new KXIGlobalManager();
        const Login = new Login_POM();
        ...
        it.skip(kGM.weightNotChanged, () => {
          ...
          kxi.verifyweightNotChangedonInsight();
        });
      }
    );
  }
