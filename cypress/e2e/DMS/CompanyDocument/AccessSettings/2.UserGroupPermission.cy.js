...
describe(
  "Verify Access Settings with View & Edit Permissions from UserGroup",
  ...
  () => {
    ...
    context(
      "[User Group] - Assign User Group Field Value and verify Edit Access",
    ...
    context(
      "[User Group] - Assign User Group Field Value and verify only View Access",
      { tags: ["@pd46111", "@pd46106", "@pd46110", "@pd46104"] },
      () => {
        AccessSettingsData.testData.fileNames.forEach((fileName) => {
          it(
