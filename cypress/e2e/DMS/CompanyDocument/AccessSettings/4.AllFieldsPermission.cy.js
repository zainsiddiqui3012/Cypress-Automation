...
describe(
  "Verify Access Settings with View & Edit Permissions from All Fields (User, User Group, Organizational Group)",
  ...
  () => {
    ...
    context(
      "[All Fields User, UserGroup, OrgGroup] - Assign All Field Value and verify Edit Access",
          ...
          it(
            ...
            () => {
              ...
              accessSettings.selectAccessFields(
                ...
                testData.correctData.userGroup,
                true
              );
              accessSettings.selectAccessFields(
    ...
    context(
      "[All Fields User, UserGroup, OrgGroup] - Assign All Field Value and verify only View Access",
      { tags: ["@pd46111", "@pd46106", "@pd46110", "@pd46104"] },
      () => {
        AccessSettingsData.testData.fileNames.forEach((fileName) => {
          it(
