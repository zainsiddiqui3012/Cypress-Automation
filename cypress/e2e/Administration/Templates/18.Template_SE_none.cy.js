...
const assessmentDataString =
  "cypress/fixtures/Administration/Assessments_SE.json";
...
describe(
  "Assessment Template SE- Test Scenarios from (None Space) Filter Import Functionality",
  {
    tags: [
      "@pd32038",
      "@assessment",
      "@simple-exception-assessment",
      "@none-space",
      "@administration",
      "@regression",
    ],
  ...
  () => {
    ...
    context("Filter QB", () => {
      before(() => {
        ...
        template.updateAssessmentDataFile("Assessments_SE.json");
      });
      beforeEach(() => {
        cy.loginWithSession(
      ...
      // no content library is added on Simple exception template
      it.skip(
    ...
    context("verify Import Functionality..", () => {
      ...
      it(
        ...
        () => {
          ...
          template.writeImportNameToAssessment("Assessments_SE");
        }
      );
