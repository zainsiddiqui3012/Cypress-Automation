...
describe(
  "Assessment Template DAP- Test Scenarios from Customer Space Filter Import Functionality",
  {
    tags: [
      "@pd32047",
      "@assessment",
  ...
  () => {
    ...
    context("verify Import Functionality..", () => {
      ...
      it(
        ...
        { tags: ["@import", "@pd33439", "@pd33442", "@smoke"] },
        () => {
          contentLibrary.openImportModal(true);
      ...
      it(
        ...
        { tags: ["@import", "@pd33439", "@pd33440", "@smoke"] },
        () => {
          template.addUsersDataImportJson(true);
          template.uploadValidFile(true);
          template.writeImportNameToAssessment("Assessments_DAP");
        }
      );

      it("verify that imported Template should be added in the grid", { tags: ["@smoke"] }, () => {
        template.verifyTemplateGridList();
