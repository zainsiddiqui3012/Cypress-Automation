...
const assessmentDataString =
  "cypress/fixtures/Administration/Assessments_OEP.json";
...
describe(
  "Assessment Template OEP- Test Scenarios from Customer Space Filter Import Functionality",
  {
    tags: [
      "@pd32047",
      "@assessment",
  ...
  () => {
    ...
    context("Filter QB", () => {
      before(() => {
        ...
        template.updateAssessmentDataFile("Assessments_OEP.json");
      });
      beforeEach(() => {
        cy.loginWithSession(
    ...
    context("verify Import Functionality..", () => {
      ...
      it(
        ...
        () => {
          ...
          template.writeImportNameToAssessment("Assessments_OEP");
        }
      );
