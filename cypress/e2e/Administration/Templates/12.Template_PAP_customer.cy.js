...
const assessmentDataString =
  "cypress/fixtures/Administration/Assessments_PAP.json";
...
describe(
  "Assessment Template PAP- Test Scenarios from Customer Space Filter Import Functionality",
  {
    tags: [
      "@pd32047",
      "@assessment",
  ...
  () => {
    ...
    context("Filter QB", () => {
      before(() => {
        ...
        template.updateAssessmentDataFile("Assessments_PAP.json");
      });
      beforeEach(() => {
        cy.loginWithSession(
    ...
    context("verify Import Functionality..", () => {
      ...
      it(
        ...
        () => {
          ...
          template.writeImportNameToAssessment("Assessments_PAP");
        }
      );
