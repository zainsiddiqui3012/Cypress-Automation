...
describe(
  "Question Bank Form Risk Analysis- Test Scenarios (None Space) Add / Update QB",
  {
    tags: [
      "@pd32038",
      "@question-bank",
  ...
  () => {
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", false, "Assessments");
      }
    );
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", true, "Assessments");
      }
    );
  })
  }
