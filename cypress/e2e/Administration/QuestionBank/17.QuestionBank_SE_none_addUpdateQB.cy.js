...
describe(
  "Question Bank Form Simple Exception Assessment- Test Scenarios from (NoneSpace) Add / Update QB",
  {
    tags: [
      "@pd32038",
      "@question-bank",
  ...
  () => {
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", false, "Assessments_SE");
      }
    );
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", true, "Assessments_SE");
      }
    );
  })
  })