...
describe(
  "Question Bank Form SPA Assessment- Test Scenarios from (NoneSpace) Filter Import Functionality",
  {
    tags: [
      "@pd32038",
      "@question-bank",
  ...
  () => {
    ...
    it(
      ...
      { tags: ["@pd35586", "@pd35587", "@pd36024", "@pd35590", "@smoke"] },
      () => {
    ...
    it(
      ...
      { tags: ["@pd35602", "@pd35591", "@pd30364", "@smoke"] },
      () => {
    ...
    it(
      ...
      { tags: ["@publish", "@pd36028", "@pd36029","@smoke"] },
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", false, "Assessments_SPA");
      }
    );

    it(
      "verify the publish of new QB Version template after creating new version from previous published template",
      { tags: ["@publish", "@new-version", "@pd36030","@smoke"] },
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", true, "Assessments_SPA");
      }
    );
  })
  })