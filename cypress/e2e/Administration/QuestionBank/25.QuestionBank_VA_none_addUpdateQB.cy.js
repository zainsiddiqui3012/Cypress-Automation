...
describe(
  "Question Bank Form Vendor Assessment- Test Scenarios from (NoneSpace) Add / Updae QB",
  {
    tags: [
      "@pd32038",
      "@question-bank",
  ...
  () => {
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", false, "Assessments_VA");
      }
    );
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", true, "Assessments_VA");
      }
    );
  })
  })