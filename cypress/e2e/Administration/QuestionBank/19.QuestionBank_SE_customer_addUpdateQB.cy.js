...
import assessmentData from "../../../fixtures/Administration/Assessments_SE.json";
const assessmentDataString = "cypress/fixtures/Administration/Assessments_SE.json"
...
describe(
  "Question Bank Form SE Assessment- Test Scenarios (Customer Space) Add / Update QB",
  {
    tags: [
      "@pd32055",
      "@question-bank",
  ...
  () => {
    before(() => {
      ...
      assessment.updateAssessmentFile("Assessments_SE.json");
      questionBank.updateAssessmentDataFile("Assessments_SE.json");
    ...
    context("add and update Question Bank from Administration", () => {
      ...
      it.skip("sort FrameWork column", { tags: ["@pd34245"] }, () => {
        questionBank.verifyQAGridList();
        questionBank.sortFrameWork("Assessments_SE");
      });
      ...
      it(
        ...
        { tags: ["@pd34536", "@pd34537"] },
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", false, "Assessments_SE", true);
        }
      );
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", true, "Assessments_SE", true);
        }
      );
    });
})
