...
describe(
  "Question Bank Form Risk Anlalysis- Test Scenarios (Customer Space) Add / Update QB",
  {
    tags: [
      "@pd32055",
      "@question-bank",
  ...
  () => {
    before(() => {
      ...
      questionBank.updateAssessmentDataFile("Assessments.json");
    ...
    context("add and update Question Bank from Administration", () => {
      ...
      it.skip("sort FrameWork column", { tags: ["@pd34245"] }, () => {
        questionBank.verifyQAGridList();
        questionBank.sortFrameWork("Assessments");
      });
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", false, "Assessments", true);
        }
      );
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", true, "Assessments", true);
        }
      );
    });
})