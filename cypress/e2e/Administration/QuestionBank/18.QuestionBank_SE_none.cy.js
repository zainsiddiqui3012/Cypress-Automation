...
describe(
  "Question Bank Form Simple Exception Assessment- Test Scenarios from (NoneSpace) Filter Import Functionality",
  {
    tags: [
      "@pd32038",
      "@question-bank",
  ...
  context("verify Import Functionality..",()=>{
    ...
    it(
      ...
      () => {
        ...
        questionBank.writeImportNameToAssessment("Assessments_SE")
      }
    );
