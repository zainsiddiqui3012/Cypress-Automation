...
const assessmentDataString = "cypress/fixtures/Administration/Assessments_VA.json"
...
describe(
  "Question Bank Form Vendor Assessment- Test Scenarios (Customer Space) Add / Update QB",
  {
    tags: [
      "@pd32055",
      "@question-bank",
  ...
  () => {
    before(() => {
      ...
      questionBank.updateAssessmentDataFile("Assessments_VA.json");
    ...
    context("add and update Question Bank from Administration", () => {
      ...
      it.skip("sort FrameWork column", { tags: ["@pd34245"] }, () => {
        questionBank.verifyQAGridList();
        questionBank.sortFrameWork("Assessments_VA");
      });
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", false, "Assessments_VA", true);
        }
      );
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", true, "Assessments_VA", true);
        }
      );
    });
})