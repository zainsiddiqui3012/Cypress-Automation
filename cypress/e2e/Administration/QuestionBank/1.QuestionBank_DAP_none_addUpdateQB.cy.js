...
describe(
  "Question Bank Form DAP Assessment - Test Scenarios from (NoneSpace) Add / Update QB",
  {
    tags: [
      "@pd32038",
      "@question-bank",
  ...
  () => {
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", false, "Assessments_DAP");
      }
    );
    ...
    it(
      ...
      () => {
        questionBank.verifyQAGridList();
        assessment.publishQB("update", true, "Assessments_DAP");
      }
    );
  })
})