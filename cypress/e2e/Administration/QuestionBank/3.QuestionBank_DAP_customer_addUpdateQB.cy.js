...
describe(
  "Question Bank Form DAP Assessment- Test Scenarios (Customer Space) Add / Update QB",
  {
    tags: [
      "@pd32055",
      "@question-bank",
  ...
  () => {
    ...
    context("add and update Question Bank from Administration", () => {
      ...
      it("sort FrameWork column", { tags: ["@pd34245"] }, () => {
        questionBank.verifyQAGridList();
        questionBank.sortFrameWork("Assessments_DAP");
      });
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", false, "Assessments_DAP", true);
        }
      );
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", true, "Assessments_DAP", true);
        }
      );
    })
})