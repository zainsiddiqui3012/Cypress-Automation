...
describe(
  "Question Bank Form OEP Assessment- Test Scenarios (Customer Space) Add / Update QB",
  {
    tags: [
      "@pd32055",
      "@question-bank",
  ...
  () => {
    ...
    context("add and update Question Bank from Administration", () => {
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", false, "Assessments_OEP", true);
        }
      );
      ...
      it(
        ...
        () => {
          questionBank.verifyQAGridList();
          assessment.publishQB("update", true, "Assessments_OEP", true);
        }
      );
    });
  }
